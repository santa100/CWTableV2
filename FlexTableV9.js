(function () {
  ...
  // vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv  
  class FlexTableV9 extends HTMLElement {
    constructor () {
      super()
    ...
    async render (resultSet) {
      ...
      resultSet.forEach(dp2 => {
          ...
          let year_plus_1 = String(Number(cQuarter.substring(0, 3)) + 1) + '.' + cQuarter.substring(5, 6)
  ...
  // vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  customElements.define('com-sap-sample-flextablev1', FlexTableV9)
