(function () {
  ...
  // vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv  
  class FlexTableB_V40 extends HTMLElement {
    constructor () {
      super()
      ...
      resultSet.forEach(dp2 => {
          ...
          if (counterCells>1) 
          {
            ...
            if (cPercentageNumber>0)
            {
                ...
                table_output += '<td><span style="font-size:14px;">▴</span><span style="font-size:12px;">'+ cPercentage +'</span></td>'
            }
  ...
  // vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  customElements.define('com-sap-sample-flextableb', FlexTableB_V40)
